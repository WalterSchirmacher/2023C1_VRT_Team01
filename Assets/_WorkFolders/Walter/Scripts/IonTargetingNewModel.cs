...
public partial class IonTargetingNewModel : RealtimeModel {
    ...
    public string posNeg {
        get {
            return _posNegProperty.value;
        }
        set {
            if (_posNegProperty.value == value) return;
            _posNegProperty.value = value;
            InvalidateUnreliableLength();
            FirePosNegDidChange(value);
        }
    }
    ...
    public event PropertyChangedHandler<string> posNegDidChange;
    ...
    private UnreliableProperty<string> _posNegProperty;
    ...
    public IonTargetingNewModel() : base(null) {
        ...
        _posNegProperty = new UnreliableProperty<string>(4, _posNeg);
    }
    ...
    private void FirePosNegDidChange(string value) {
        try {
            posNegDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        length += _posNegProperty.WriteLength(context);
        return length;
    }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        writes |= _posNegProperty.Write(stream, context);
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            ...
            switch (propertyID) {
                ...
                case (uint) PropertyID.PosNeg: {
                    changed = _posNegProperty.Read(stream, context);
                    if (changed) FirePosNegDidChange(posNeg);
                    break;
                }
                default: {
                    stream.SkipProperty();
